...
pumpkin = GameSpirit("pumpkin.png", randrange(200, 800),randrange(100, 400), 60, 60, 5)
seeds = GameSpirit("seeds.png", randrange(200, 800),randrange(100, 400), 30, 30, 5)
...
while game:
    ...
    if finish != True:
        ...
        if sprite.collide_rect(pumpkin, ball):
            pumpkin.kill()
            speed_x = speed_y - 0.5
            speed_y = speed_y - 0.5
